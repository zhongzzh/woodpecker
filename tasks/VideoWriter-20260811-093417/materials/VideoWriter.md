...
v = VideoWriter(___;[profile](/Doc/TyImageProcessing/DataImportandAnalysis/DataImportandExport/StandardFileFormats/AudioandVideoData/ReadorWriteVideo/VideoWriter.html#x52c41f60)) 还应用一组适合特定文件格式。
